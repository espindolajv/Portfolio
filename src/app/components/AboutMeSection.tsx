...
export function AboutMeSection() {
    return (
        <section className="w-full flex flex-col justify-center items-center px-10 lg:px-72 sm:px-24 gap-20 xl:py-32 py-12" id="aboutme-section">
            ...
            <div className="flex xl:gap-28 justify-center items-center">
                ...
                <div className="xl:w-1/2 w-full flex flex-col gap-6">
                    ...
                    <div className="flex w-full">
                        <button className="w-full sm:w-auto bg-glass px-4 py-2 text-lg font-semibold rounded-lg hover:bg-white/30  hover:scale-110 duration-300 hover:z-40">Baixar CV</button>
                    </div>
                </div>
            </div>
