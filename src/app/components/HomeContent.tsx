...
export function HomeContent() {
    ...
    return (
        <div className="h-screen w-full flex flex-col items-center py-8" id="home-section">
            <div className="w-full xl:px-36 flex xl:justify-end sm:justify-center">
                <Navbar />
            </div>
            <div className="flex h-full justify-center items-center lg:px-72 sm:px-24 gap-20">
                <div className="w-1/2 h-2/3 bg-glass rounded-xl xl:flex sm:hidden" />
                
                <div className="flex flex-col gap-12 xl:w-1/2 sm:w-full text-start">
                    <div className="flex flex-col gap-3">
                        <h2 className="text-4xl font-semibold">Olá, sou João Victor Macedo e esse é meu Portfólio.</h2>
                        <h3 className="text-2xl italic">Desenvolvedor FullStack</h3>
                    </div>
